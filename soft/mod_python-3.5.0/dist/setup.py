...
def generate_version_py():
    with open(os.path.join(getmp_mpdir(), 'version.py'), 'w') as version_py:
        ...
        version_py.write('TEST_MOD_PYTHON_SO = "/home/cheungssh/soft/mod_python-3.5.0/src/mod_python.so" #NB: This is for test.py only\n')
        version_py.write('TESTHOME = "/home/cheungssh/soft/mod_python-3.5.0/test"\n')
