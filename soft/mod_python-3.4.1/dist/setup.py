...
def getmp_version():
  return commands.getoutput('./version.sh')
...
def generate_version_py():
    with open(os.path.join(getmp_mpdir(), 'version.py'), 'w') as version_py:
        ...
        version_py.write('HTTPD = "/usr/sbin/httpd"\n')
        version_py.write('HTTPD_VERSION = "2.2.15"\n')
        version_py.write('APR_VERSION = "1.3.9"\n')
        version_py.write('LIBEXECDIR = "/usr/lib64/httpd/modules"\n')
        version_py.write('SYSCONFDIR = ""\n')
        version_py.write('TEST_MOD_PYTHON_SO = "/home/cheungssh/soft/mod_python-3.4.1/src/mod_python.so" #NB: This is for test.py only\n')
        version_py.write('TESTHOME = "/home/cheungssh/soft/mod_python-3.4.1/test"\n')
